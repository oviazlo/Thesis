...
\DeclareRobustCommand{\ttbar}{\antibar{t}\xspace}
\DeclareRobustCommand{\pp}{\textit{pp}\xspace}
...
\def\wpssm{\ensuremath{W'_{\textrm SSM}}}
\def\mwp{\ensuremath{m_{\PWprime}}}
...
% USAGE: 
% \begin{overpic}[width=0.5\textwidth,grid,tics=10]{momentum_resolution.png}
%  \put (20,10) {\crule[blue]{0.1\textwidth}{0.1\textwidth}}
% \end{overpic}
