...
main.pdf: main.tex $(addprefix otherText/,preamble.tex frontmatter.tex appendices.tex) $(addprefix mainChapters/,chap1.tex chap2.tex chap3.tex chap4.tex monoW.tex)
	@rm -f $(EXTRASTYS)
