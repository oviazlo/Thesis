...
\title{Search for beyond Standard Model physics with high-$p_T$ leptons}
...
\hypersetup{%
  pdftitle = {Search for beyond Standard Model physics with high-$p_T$ leptons},
