...
\SectionRef{sec:trt_tracking_perf} describes a performance study of the TRT regarding hit and track parameters with focus on an active gas mixture, and particularly the comparison of 
Xenon- and Argon-based mixtures.
In \SectionRef{sec:trt_summary} conclusion of the Argon studies are made.
