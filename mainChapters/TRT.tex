...
\begin{figure}[h]
\begin{center}
% \includegraphics[width=0.69\columnwidth]{TRT/diffusion_v2.eps}
  \begin{overpic}[width=0.69\columnwidth]{TRT/diffusion.eps}
    \put (33,48) {\crule[myGray]{0.1\textwidth}{0.024\textwidth}}
  \end{overpic}
...
\caption{Simulation of the precision hit fraction as a function of $\phi$ in configurations with all straws filled with Xenon (left) and Argon (right) gas mixtures in the barrel detector.}
