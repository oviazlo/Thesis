\chapter{Simulation and performance of the Transition Radiation Tracker with Argon-based gas mixture}
\label{chap:TRT}
...
TRT was built with focus on using Xenon mixture with carbon dioxide and oxygen additiona (in proportion 70/27/3).
...
Second chapter cover overview of the simulation package with description of Argon implementation in it.
...
I was working on Argon simulation for 1.5 years and my implementation was integrated to the official TRT digitization 
package. I performed study on hit and track parameters with respect to the used gas.
...
As described previously purpose of the TRT detector is not only to provide good track reconstruction (which means list of hits)???

Signal from the straws has a specific shape as shown in \FigureRef{fig:ion_tail}.
...
\subsection{Tracking with TRT}

%#######################################################################################################################
% SECTION 2 ############################################################################################################
%#######################################################################################################################
\section{Implementation of modelling of the new Argon-based gas mixture in TRT}
...
\subsection{Simulation and digitization of the TRT}
...
\subsection{Digitization of the mixed gas condition}
...
\subsection{The influence of the magnetic flux density on drift time}
...
\subsection{Modelling of White Noise}
...
\subsection{TRT hit and track parameters}
...
\subsection{Hit efficiency, number of hits per track and track extension fraction}
