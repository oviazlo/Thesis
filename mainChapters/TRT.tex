...
\subsection{Photo absorption ionization model}
...
\subsection{Influence of the magnetic flux density on the drift time}
% \subsection{Simulation of timing variables}
% TODO revisit this section
% TODO just say that previous studies (cite to Esben/Kittelman/Cwetanski thesis) showed that dependence can be fitted by function.
