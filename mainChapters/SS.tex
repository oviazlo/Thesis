...
In order to be conservative the lowest obtained efficiency, which was 48.3$\%$, have been decided to be used for cross section limits.
...
are shown in \FigureRef{fig:inclusive_fid_limit}. 
