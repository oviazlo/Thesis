...
% There is number of inclusive searches which target same-sign dilepton final state as well as searches with additional requirements on number of jets or missing transverse momentum in ATLAS~\cite{heavy_majorana_neutrino_paper,floderus_paper,Aad:2014pda}.
...
\begin{subfigure}{.5\textwidth}
  ...
  \begin{overpic}[width=\textwidth]{SS/support_note/chargeflip/eta_mctruth.eps}
    \put (20,63) {\crule[white]{0.3\textwidth}{0.05\textwidth}}
  \end{overpic}
...
\begin{subfigure}{.5\textwidth}
  ...
  \begin{overpic}[width=\textwidth]{SS/support_note/chargeflip/misidratept_datamc.eps}
    \put (20,63) {\crule[white]{0.2\textwidth}{0.05\textwidth}}
  \end{overpic}
...
\footnote{$m_\mathrm{T} = \sqrt{2 p_\mathrm{T} E_T^{miss} (1-\cos\varphi_{\Plepton\nu})}$, where
$p_\mathrm{T}$ is the transverse momentum of the electron, $E_T^{miss}$ is the missing transverse momentum of the event
...
\begin{overpic}[width=0.65\textwidth]{SS/support_note/dielectrons/crs/OS_mod_v4.pdf}
    \put (30,53) {\crule[white]{0.17\textwidth}{0.03\textwidth}}
\end{overpic}
...
\begin{overpic}[width=0.65\textwidth]{SS/support_note/PromptCR/ElEl/2isoSS_ee_mll_pr.eps}
    \put (45,78.3) {\crule[white]{0.14\textwidth}{0.02\textwidth}}
\end{overpic}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{ l | r r r r r r r }
        \hline
        Validation region 		& Fakes 			& Prompt 	& Charge Flip 			& W$\gamma$ 		& Total Pred 			& Data		&  Agreement \\
            \hline

        Medium electron identification 	& $ 111.04 \pm 27.4 $	&	$ 2.9 \pm 0.5 $	& $ 72.46 \pm 16.75 $		& $ 8.78 \pm 2.3 $	& $ 195.18 \pm 32.2 $		& $ 217 \pm 15 $&  -0.62 $\sigma$\\
        Weak isolation on both electrons 	& $ 252.9 \pm 133.64 $	& $ 1.23 \pm 0.3 $	& $ 29.07 \pm 10.1 $		& $ 0.27 \pm 0.28 $	& $ 283.47 \pm 134.02 $		& $285 \pm 17 $	&  -0.01 $\sigma$\\
        Weak isolation on subleading electron 	& $ 519.21 \pm 120.72 $ & $ 32.88 \pm 2.14 $	& $ 52.69 \pm 14.87 $		& $ 17.64 \pm 4.32 $	& $ 622.42 \pm 121.72 $		& $574 \pm 24 $ &  0.39 $\sigma$\\
        Weak isolation on leading electron 	& $ 154.97 \pm 58.67 $  & $ 13.28 \pm 1.21 $	& $ 15.96 \pm 7.5 $		& $ 5.12 \pm 1.72 $	& $ 189.33 \pm 59.19 $		& $ 224 \pm 15 $&  -0.57 $\sigma$\\
...
\begin{subfigure}{.5\textwidth}
  ...
  \begin{overpic}[width=\textwidth]{SS/support_note/dielectrons/crs/dec13_fake_medium_v2.eps}
    \put (45,63) {\crule[white]{0.21\textwidth}{0.03\textwidth}}
  \end{overpic}
...
\begin{subfigure}{.5\textwidth}
  ...
  \begin{overpic}[width=\textwidth]{SS/support_note/dielectrons/crs/dec13_fake_bothInter_v2.eps}
    \put (44,62) {\crule[white]{0.23\textwidth}{0.03\textwidth}}
  \end{overpic}
...
\begin{subfigure}{.5\textwidth}
  ...
  \begin{overpic}[width=\textwidth]{SS/support_note/dielectrons/crs/dec13_fake_leadNom_sublInter_v2.eps}
    \put (44,63) {\crule[white]{0.23\textwidth}{0.03\textwidth}}
  \end{overpic}
...
\begin{overpic}[width=0.7\textwidth]{SS/support_note/dielectrons/crs/signal_deltaPhi_v2.eps}
 \put (30,63) {\crule[white]{0.18\textwidth}{0.02\textwidth}}
\end{overpic}
...
\begin{subfigure}{.5\textwidth}
  ...
  \begin{overpic}[width=\textwidth]{SS/support_note/limits/limit_ee_neg.eps}
    \put (45,51.6) {\crule[white]{0.21\textwidth}{0.024\textwidth}}
  \end{overpic}
...
\begin{overpic}[width=0.7\textwidth]{SS/support_note/DCHPlots/ee/2isoSS_ee_mll_dch.eps}
  \put (45,58.9) {\crule[white]{0.16\textwidth}{0.02\textwidth}}
\end{overpic}
...
As one can see from \TableRef{tab:DCH_limit_vs_years} mass limits benefit from the larger center of mass \textit{pp} collision data though using a dataset with larger integrated luminosity will improve limits further.
...
As was mentioned before, the analyses have been performed with three channels: $e^{\pm}e^{\pm}$, $\mu^{\pm}\mu^{\pm}$ and $e^{\pm}\mu^{\pm}$. However, it might be possible to add a tau lepton channel, which would complement results from the other three. 
