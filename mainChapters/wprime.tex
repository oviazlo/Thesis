...
\begin{itemize}
 ...
 \item Missing transverse momentum, $E_T^{miss}$. Along with the lepton momentum, $E_T^{miss}$ is used in the calculation of the transverse invariant mass $m_T$ (which will be defined in \SectionRef{subsec:etmiss}),
...
\begin{subfigure}{.5\textwidth}
  ...
  \begin{overpic}[width=\textwidth]{Wprime/WenuPlus_TruthLepBornElectrons_hist_invmass_notStacked.eps}
    \put (50,51) {\crule[white]{0.3\textwidth}{0.15\textwidth}}
    \put (75,1) {\crule[white]{0.25\textwidth}{0.05\textwidth}}
    \put (77,3) { \includegraphics[width=0.16\textwidth]{Wprime/label_m_inv-crop.pdf} }
  \end{overpic}
...
\begin{subfigure}{.5\textwidth}
  ...
  \begin{overpic}[width=\textwidth]{Wprime/WenuPlus_TruthLepBornElectrons_hist_mt_logX_notStacked.eps}
    \put (50,51) {\crule[white]{0.3\textwidth}{0.15\textwidth}}
    \put (70,1) {\crule[white]{0.3\textwidth}{0.05\textwidth}}
    \put (77,3) { \includegraphics[width=0.16\textwidth]{Wprime/label_mT-crop.pdf} }
  \end{overpic}
...
The transverse mass has to be $m_T > 110$~GeV which corresponds to twice the required  value of the muon
...
\begin{figure}[]
  ...
  \begin{overpic}[width=0.49\textwidth]{Wprime/METloose.eps}
    \put (55,25) {\crule[white]{0.2\textwidth}{0.024\textwidth}}
    \put (81.6,25.5) {\includegraphics[scale=.35]{Wprime/etmiss_label-crop.pdf}}
  \end{overpic}
...
%   \includegraphics[width=0.49\textwidth]{Wprime/muon_MET.eps}
  \includegraphics[width=0.49\textwidth]{Wprime/hist_pt_muon.eps}
  \includegraphics[width=0.49\textwidth]{Wprime/hist_met_muon.eps}
 \caption{
...
\begin{figure}[]
  \centering
  \includegraphics[width=0.65\textwidth]{Wprime/hist_mt_muon_paper.png}
  \caption{
