...
\begin{figure}
\centering
\includegraphics[width=.7\textwidth]{LUCID/LEDdiffuser.png}
...
Fig.~\ref{fig:Eletronics_schematics}).
...
The PMT pulseheight distribution in a physics run is shown in the left plot of Fig.~\ref{fig:Pulseheight} (blue) 
...
In the right plot of Fig.~\ref{fig:Pulseheight} a comparison of the pulseheight distributions in a physics run 
with
...
LUCID can measure luminosity in many ways and Fig.~\ref{fig:InternalConsistency} shows a comparison of the 
...
The left plot of Fig.~\ref{fig:LumiVsTime} shows a measurement of the average number of inelastic pp collisions 
