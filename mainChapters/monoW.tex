...
For EFT approach W can be produces as final state particle \FigureRef{fig:WWxx} as well as initial state radiation \FigureRef{fig:D52}.

\begin{figure}[hb]
  \subfloat[]{\label{fig:cc1a}\includegraphics[width=0.3\textheight]{monoW/simplifiedDM_diagram.pdf}}\quad
  \subfloat[]{\label{fig:cc1d}\includegraphics[width=0.3\textheight]{monoW/simplified_tChannel_model_diag.pdf}}
...
\begin{figure}[hb]
  \subfloat[]{\label{fig:WWxx}\includegraphics[width=0.3\textheight]{monoW/WWxx_diagramm_v2.pdf}}\quad
  \subfloat[]{\label{fig:D52}\includegraphics[width=0.3\textheight]{monoW/EFT_D5_model_diag_v3.pdf}}
