...
In the \FigureRef{fig:peakMuByFill} one can see that the maximum number of interactions per beam crossing for some physics runs in 2016 were higher than 40-45. At this values, the statistical error of the BI$\_$OR$\_$A algorithm exceeds 2$\%$, which is too large errors for the physics runs.
...
% TODO check if 144 is corect number!!!
